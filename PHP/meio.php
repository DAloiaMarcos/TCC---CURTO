...
<section id="section1-home">
        ...
        <div class="section1-home-botao">
            <a href="index.php?a=2"><input type="button" value="Cadastre-se" class="botao-section1-home"></a>

            <a href="index.php?a=4"><input type="button" value="Conheça" class="botao-section1-home"></a>
        </div>
        </div>
        <!-- Triangulo -->
